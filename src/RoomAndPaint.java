...
public class RoomAndPaint {
    ...
    // Constructor
    public RoomAndPaint(double length, double width, double height, int numWindows, int numDoors) {
        this.length = length;
        this.width = width;
        this.height = height;
    ...
    public static void main(String[] args) {
        ...
        RoomAndPaint roomAndPaint = new RoomAndPaint(length, width, height, numWindows, numDoors);
